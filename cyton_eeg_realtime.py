...
def main():
    ...
    # This part was modified using the documentation specific to the Cyton board
    # https://brainflow.readthedocs.io/en/stable/SupportedBoards.html#cyton

    parser.add_argument('--serial-port', type=str,
                        help='Serial port for Cyton, e.g., COM3, /dev/ttyUSB0 (use /dev/cu... on macOS)',
                        required=True)
    parser.add_argument('--board-id', type=int, help='Board ID, should be BoardIds.CYTON_BOARD',
                        default=BoardIds.CYTON_BOARD)
